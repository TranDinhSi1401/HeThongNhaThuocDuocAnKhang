...
public class ThemSanPhamGUI extends javax.swing.JPanel {
    ...
    private void xuLyXacNhan() {
        ...
        try {
            ...
            String moTa = jTextField3.getText().trim();
            String thanhPhan = jTextField4.getText().trim();
            LoaiSanPhamEnum loai = null;
            if(jComboBox1.getSelectedItem().toString().equals("Thuốc kê đơn")) {
                loai = LoaiSanPhamEnum.THUOC_KE_DON;
            } else if (jComboBox1.getSelectedItem().toString().equals("Thuốc không kê đơn")) {
                loai = LoaiSanPhamEnum.THUOC_KHONG_KE_DON;
            } else {
                loai = LoaiSanPhamEnum.THUC_PHAM_CHUC_NANG;
            }
