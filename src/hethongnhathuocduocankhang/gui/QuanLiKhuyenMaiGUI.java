 ...
 * @author trand
 */
public class QuanLiKhuyenMaiGUI extends javax.swing.JPanel {
    ...
    /**
     * Creates new form QuanLiKhuyenMai
     */
    public QuanLiKhuyenMaiGUI() {
        ...
        // 3.1. Bảng dữ liệu
        String[] columnNames = {"Mã khuyến mãi", "Mô tả", "Phần trăm", "Loại khuyến mãi", "Ngày bắt đầu", "Ngày kết thúc", "Số lượng tối thiểu", "Số lượng tối đa", "Ngày chỉnh sửa"};
        Object[][] data = {
            {"", "", "", "", "", "", "", ""}, 
            {"", "", "", "", "", "", "", ""}, 
            {"", "", "", "", "", "", "", ""}, 
