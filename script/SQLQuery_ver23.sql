...
-- 5. Bảng Tài Khoản (Đã thêm daXoa và quanLyLo)
CREATE TABLE TaiKhoan (
    ...
    quanLyLo BIT NOT NULL CONSTRAINT DF_TaiKhoan_QuanLyLo DEFAULT 0, -- true: Quản lý lô, false: Không
...
CREATE TABLE LichSuLo (
    maLichSuLo NVARCHAR(20) PRIMARY KEY,
    ...
    CONSTRAINT FK_LichSuLo_LoSanPham FOREIGN KEY (maLoSanPham) 
        REFERENCES LoSanPham(maLoSanPham) 
        ON DELETE CASCADE,

    CONSTRAINT FK_LichSuLo_NhanVien FOREIGN KEY (maNV) 
        REFERENCES NhanVien(maNV),

    CONSTRAINT CK_LichSuLo_MaLichSuLo_Format CHECK (maLichSuLo LIKE 'LSL-[0-9][0-9][0-9][0-9]')
);
GO
...
-- 7. Bảng TaiKhoan
-- ===================================================================
INSERT INTO TaiKhoan (tenDangNhap, matKhau, quanLyLo, quanLy, biKhoa, email, ngayTao) VALUES
('NV-0001', N'$2a$12$gn8WcfAE66kyqsl.Of78Uuafh8uhulZ3hWJuUphOEzoFnhSdAPRFq', 0, 0, 0, N'votienkhoa435@gmail.com', '2025-01-01 08:00:00'),
('NV-0002', N'$2a$12$KGIFfbyWWaUqQVJ1tvtP4.xscY569jCSeajDN2G8ld0fvAutAv75u', 0, 1, 0, N'khangdz013@gmail.com', '2025-01-01 08:01:00'),
('NV-0003', N'$2a$12$XR2GrxuO7qAlhaKDsKwebO.fcIKCMMUjnqrwBJ.s8aJ1sulKx2FA.', 1, 0, 0, N'nguyenkhanhquan9999@gmail.com', '2025-01-01 08:02:00'),
('NV-0004', N'$2a$12$ZVKoL.rhx/8F/DDu5EWHzuof6GmslFqX3D7IEFS9b3NvZM7N.adN2', 0, 0, 0, N'tistis14012k5@gmail.com', '2025-01-01 08:03:00');
GO
...
update KhachHang
set diemTichLuy = bangtam.tongtien/1000
from KhachHang kh join (
	select kh.sdt as sdt, sum(hd.tongTien) as tongtien from KhachHang kh join HoaDon hd
	on kh.maKH = hd.maKH
	group by kh.sdt
) as bangtam on kh.sdt = bangtam.sdt
where kh.sdt = bangtam.sdt
GO
